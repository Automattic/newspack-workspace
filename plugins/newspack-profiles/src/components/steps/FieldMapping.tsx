...
export const FieldMapping = () => {
	...
	return (
		<div className="px-6 py-2">
			...
			<div className="border border-gray-400 rounded w-fit overflow-hidden mt-6">
				<div className="grid grid-cols-[20px_24px_2fr_2fr_1fr_auto] gap-4 p-4 m-0 flex items-center border-b border-gray-400 bg-gray-100">
					<span></span>
					<span></span>
	...
	return (
		<li
			...
			className={ classNames(
				'grid grid-cols-[20px_24px_2fr_2fr_1fr_auto] gap-4 p-4 m-0 flex items-center transition-colors duration-200',
				{
					'bg-white border-b border-gray-300 last:border-0':
						! isDragging && ! isMoving,
					'bg-gray-100 border border-gray-300 rounded-sm':
						isDragging || isMoving,
					'opacity-50': mapping?.visible === false,
				}
			) }
		>
			<Tooltip
			...
			>
				<span ref={ handleRef } className="cursor-move">
					<Icon icon="menu" className="text-gray-500" />
				</span>
			</Tooltip>
			...
			<div className="flex flex-col">
				<span className="text-base break-all">{ dataSourceField }</span>
				{ sampleData && (
