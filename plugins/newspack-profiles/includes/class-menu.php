...
class Menu {
	...
	/**
	 * Page slug for the profile collections list page.
	 */
	const PROFILE_COLLECTIONS_LIST_SLUG = 'newspack-profiles-settings';

	/**
	 * Page slug for creating a new profile collection.
	 */
	...
	public function register_admin_menu(): void {
		...
		add_menu_page(
			esc_html__( 'Profile Collections', 'newspack-profiles' ),
			esc_html__( 'Profile Collections', 'newspack-profiles' ),
			'manage_options',
		...
		add_submenu_page(
			self::PROFILE_COLLECTIONS_LIST_SLUG,
			esc_html__( 'All Profile Collections', 'newspack-profiles' ),
			esc_html__( 'All Profile Collections', 'newspack-profiles' ),
			'manage_options',
			self::PROFILE_COLLECTIONS_LIST_SLUG,
			array( $this, 'render_admin_page' ),
		...
		add_submenu_page(
			self::PROFILE_COLLECTIONS_LIST_SLUG,
			esc_html__( 'Add New Profile Collection', 'newspack-profiles' ),
			esc_html__( 'Add New Profile Collection', 'newspack-profiles' ),
			'manage_options',
	...
	public function render_admin_page(): void {
		?>
			<div id="newspack-profiles-settings-root" class="newspack-profiles-tailwind">
