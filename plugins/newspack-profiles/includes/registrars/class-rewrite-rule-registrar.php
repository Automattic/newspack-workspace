<?php
/**
 * Rewrite rule registrar for profile collection URLs.
 *
...
class Rewrite_Rule_Registrar {
	...
	public function register_rewrite_rules(): void {
		 ...
		 * This will only run when a profile collection is added or deleted.
		 * We need to flush rewrite rules to ensure the new rewrite rules for newly added
		 * profile collections are registered and old ones are removed.
		 */
