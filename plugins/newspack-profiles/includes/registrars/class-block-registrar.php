...
class Block_Registrar {
				...
				array(
					...
					'overrides'         => array(
						array(
							...
							/* translators: %s is the profile collection slug */
	...
	/**
	 * Get block patterns based on the profile collection configuration.
	 *
	 * @param array           $config Profile collection configuration.
