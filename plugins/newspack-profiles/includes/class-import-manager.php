<?php
/**
 * Import manager for profile collections from remote data sources.
 *
...
/**
 * Import_Manager class to handle profile collection imports from remote data sources.
 */
class Import_Manager {
	...
	/**
	 * Import profile collection data based on configuration.
	 *
	 * @param array $profile_collection_config The profile collection configuration.
	 *
	 * @return bool
	 */
	 ...
	 * @param string $slug The profile collection slug.
	 *
	 * @return void
	 */
	...
	private function finish_import( string $slug ): void {
		...
		$source_config = array(
			...
			'service_config' => array(
				/* translators: %s is the profile collection label */
	 ...
	 *
	 * @param array $collection The profile collection configuration.
	 *
	 * @return void
	 */
