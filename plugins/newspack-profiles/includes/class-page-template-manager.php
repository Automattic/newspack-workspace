<?php
/**
 * Page template manager for profile collections.
 *
...
/**
 * Page_Template_Manager class to manage page templates for profile collections.
 */
class Page_Template_Manager {
	...
	public function register_post_type(): void {
		register_post_type(
			...
			array(
				'labels'              => array(
					'name'          => __( 'Newspack Profile Collection Templates', 'newspack-profiles' ),
					'singular_name' => __( 'Newspack Profile Collection Template', 'newspack-profiles' ),
				),
				'public'              => true,
	...
	/**
	 * Create pages for a profile collection.
	 *
	 * @param array $config Configuration for the profile collection.
	 *
	...
	/**
	 * Update pages associated with a profile collection.
	 *
	 * @param array           $config Configuration for the profile collection.
	...
	/**
	 * Delete pages associated with a profile collection.
	 *
	...
	/**
	 * Update the status of pages associated with a profile collection.
	 *
	 * @param array  $config Configuration for the profile collection.
