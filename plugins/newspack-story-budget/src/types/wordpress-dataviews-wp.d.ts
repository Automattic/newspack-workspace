 ...
 *
 * That subpath is the build variant `stories.tsx` imports `DataViews` from, so the
 ...
 * Mirroring the root package's types here fixes that for every file in
 * the program (ambient module declarations apply program-wide, not just
 * to this file).
 *
