...
describe( 'sites utils', () => {
	beforeEach( () => {
		...
		// Mock location and URL handling. `Object.defineProperty` (rather than
		// `delete`-then-reassign) sidesteps `location`'s non-optional,
		// not-freely-assignable typing -- `PropertyDescriptor.value` is untyped,
		// and jsdom happily swaps the whole object out underneath it.
