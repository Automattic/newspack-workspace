...
export function apiFetch( request: APIFetchOptions ): { type: 'STORY_BUDGET_FETCH'; request: APIFetchOptions } {
	return {
...
export const controls = {
	STORY_BUDGET_FETCH( { request }: { request: APIFetchOptions } ): Promise< unknown > {
