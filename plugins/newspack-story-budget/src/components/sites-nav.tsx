...
export default function SitesNav() {
	...
	const leaveLabel = sprintf(
		...
		// `getCurrentSiteName()` is typed `string | null`, but this label is only ever
		// rendered when `remoteSite` is set, in which case the name is always resolved.
		getCurrentSiteName() as string
	);
	return (
