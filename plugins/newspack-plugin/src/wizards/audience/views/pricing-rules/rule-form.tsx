					...
					<VStack spacing={ 6 }>
						...
						{ recipe?.isCustom && (
							<ToggleControl
								...
								help={ __(
									"On: subscribers keep the rule's terms from the day they bought or reactivated — later edits to the rule don't reach them. Percentage and amount-off discounts follow the product's current regular price. Off: the rule applies to every matching subscriber at each renewal.",
									'newspack-plugin'
								) }
