<?php
/**
 * Newspack Subscribers Discounts Demo.
 *
 * @package Newspack
 */
...
/**
 * Subscribers discounts demo wizard.
 */
class Subscribers_Discounts_Demo extends Wizard {
	 ...
	 * @var string
	 */
	protected $slug = 'newspack-subscribers-discounts-demo';
	...
	public function get_name() {
		return esc_html__( 'Subscribers demo (discounts)', 'newspack' );
	}
	...
	/**
	 * Enqueue Subscribers Discounts Demo scripts and styles.
	 */
	public function enqueue_scripts_and_styles() {
		...
		$asset = include NEWSPACK_ABSPATH . 'dist/subscribersDiscountsDemo.asset.php';

		wp_enqueue_script(
			'newspack-subscribers-discounts-demo',
			Newspack::plugin_url() . '/dist/subscribersDiscountsDemo.js',
			$asset['dependencies'],
			$asset['version'],
			true
		);
		...
		wp_enqueue_style(
			'newspack-subscribers-discounts-demo',
			Newspack::plugin_url() . '/dist/subscribersDiscountsDemo.css',
			[ 'wp-components' ],
