...
import type { HeaderAction, QueryView, Term, View } from '../../types';
...
export default function AdvertisersListScreen(): ReactElement {
	...
	const { data, paginationInfo, isLoading, hasResolved, hasLoadedOnce } = useAdvertisersData( queryView, mutationKey );
	...
	const openEdit = useCallback( ( advertiser: Term ) => setModalState( { mode: 'edit', advertiser } ), [] );
	...
	const dataViewsProps = {
		...
		isLoading,
		getItemId: ( item: Term ) => String( item.id ),
		search: true,
