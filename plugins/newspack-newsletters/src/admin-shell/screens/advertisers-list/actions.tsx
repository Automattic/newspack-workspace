...
import type { ListAction, Term } from '../../types';

const TAXONOMY_PATH = '/wp/v2/newspack_nl_advertiser';

const deleteOne = ( id: number ) => apiFetch( { path: `${ TAXONOMY_PATH }/${ id }?force=true`, method: 'DELETE' } );
...
export function getActions( { onEdit, onMutated }: GetActionsArgs ): ListAction< Term >[] {
	const editAction: ListAction< Term > = {
		id: 'edit',
	...
	const deleteAction: ListAction< Term > = {
