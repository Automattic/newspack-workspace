...
import type { Field, FieldRenderProps, Term } from '../../types';

interface GetFieldsArgs {
	onEdit?: ( item: Term ) => void;
}

export function getFields( { onEdit }: GetFieldsArgs = {} ): Field< Term >[] {
	const renderName = ( { item }: FieldRenderProps< Term > ) => {
