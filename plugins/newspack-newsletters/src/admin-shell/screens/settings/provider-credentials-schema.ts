...
import type { ProviderCredentialField } from './types';

const PROVIDER_CREDENTIAL_SCHEMAS: Record< string, ProviderCredentialField[] > = {
	mailchimp: [
		{
			key: 'api_key',
...
export function getProviderCredentialFields( slug: string ): ProviderCredentialField[] {
