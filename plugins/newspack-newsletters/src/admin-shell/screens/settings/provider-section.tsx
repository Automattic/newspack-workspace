...
import type { ProviderChoice, ProviderState } from './types';
...
export default function ProviderSection( {
	...
	const handleAuthorize = () => {
		...
		// Only reachable via the "Authorize" button, which renders solely when `showOAuthNotice` is true — i.e. `oauth` is set.
