...
interface LocalListDeleteModalProps {
...
export default function LocalListDeleteModal( { list, onConfirm, onCancel, isBusy }: LocalListDeleteModalProps ): ReactElement | null {
	if ( ! list ) {
		return null;
	}
	return (
