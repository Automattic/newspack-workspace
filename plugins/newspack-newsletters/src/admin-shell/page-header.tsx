...
const variantFor = ( type: HeaderAction[ 'type' ] ): 'primary' | 'secondary' => ( 'primary' === type ? 'primary' : 'secondary' );

function useNewspackHeader(): Element | null {
	const [ target, setTarget ] = useState< Element | null >( () => document.querySelector( NEWSPACK_HEADER_SELECTOR ) );
...
function ActionButtons( { actions }: { actions: HeaderAction[] } ): ReactElement {
	return (
		<>
...
export default function PageHeader(): ReactElement | null {
