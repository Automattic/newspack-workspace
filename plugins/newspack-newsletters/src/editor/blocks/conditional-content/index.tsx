...
const addConditionalContentAttributes = ( settings: BlockSettingsWithAttributes ) => {
						...
						<VStack spacing={ 4 }>
							...
							<TextControl
								...
								help={ sprintf(
									...
									String( config?.example?.after )
								) }
								__next40pxDefaultSize
							/>
							<ExternalLink href={ String( config?.support_url ) }>
