...
interface EmbedPreviewProps {
	...
	insertBlocksAfter: ( blocksToInsert: unknown ) => void;
	isSelected?: boolean;
}

interface EmbedBlockEditProps {
	name: string;
...
export default () => {
	...
	wp.hooks.addFilter( 'editor.BlockEdit', 'newspack-newsletters/embed-block-edit-editor', ( BlockEdit: ComponentType< EmbedBlockEditProps > ) => {
		return ( props: EmbedBlockEditProps ) => {
