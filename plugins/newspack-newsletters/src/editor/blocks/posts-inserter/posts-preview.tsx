 ...
 */
const PostsPreview = ( { isReady, blocks, className, viewportWidth }: PostsPreviewProps, ref: ForwardedRef< HTMLDivElement > ) => {
	// Iframe styles are not properly applied when nesting iframed editors.
	// This fix ensures the iframe is properly styled.
	const useIframeBorderFix = useRefEffect( ( node: HTMLElement ) => {
