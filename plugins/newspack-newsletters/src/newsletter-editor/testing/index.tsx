...
/** Props supplied by the JSX caller; the rest of TestingProps is injected by the compose() chain below. */
interface TestingOwnProps {
	testEmail: string;
...
interface TestingProps extends TestingOwnProps {
...
/** Response shape read from the test-send endpoints. */
...
export default compose(
	withApiHandler(),
	withSelect( select => {
		const { getCurrentPostId } = select( 'core/editor' ) as {
...
) as ComponentType< TestingOwnProps >;
