...
final class Sovrn {
	...
	public static function init() {
		...
		if ( ! defined( 'NEWSPACK_ADS_EXPERIMENTAL_BIDDERS' ) ) { // phpcs:ignore phpcsSniffs.Constants.ConstantDocblock.Missing -- Documented in plugins/newspack-ads/includes/bidders/class-openx.php.
			return;
		}
