...
type ExpirationPanelProps = Pick< PromptEditorProps, 'expiration_date' | 'postStatus' | 'onMetaFieldChange' | 'createNotice' | 'removeNotice' >;

const ExpirationPanel = ( { expiration_date = null, postStatus, onMetaFieldChange, createNotice, removeNotice }: ExpirationPanelProps ) => {
	const [ noticeId, setNoticeId ] = useState< string | false >( false );
	useEffect( () => {
