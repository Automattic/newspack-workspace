...
type StylesSidebarProps = Pick< PromptEditorProps, 'onMetaFieldChange' | 'hide_border' | 'large_border' | 'no_padding' | 'isOverlay' >;

const StylesSidebar = ( props: StylesSidebarProps ) => {
