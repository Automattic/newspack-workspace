...
import type { CoreEditorSelectors, PromptMeta } from './utils';

const EditorAdditions = () => {
	const meta =
		( useSelect( select => ( select( 'core/editor' ) as CoreEditorSelectors ).getEditedPostAttribute( 'meta' ) ) as PromptMeta | undefined ) ||
		( {} as PromptMeta );
