/**
 * Options accepted by `rememberSessionSignal()`.
 */
interface RememberSessionSignalOptions {
	/** Query-param name to read. */
	param: string;
	/** sessionStorage key under which a positive arrival is remembered. */
	sessionKey: string;
	/** Predicate receiving the decoded (non-null) param value; returns whether it is a positive signal. */
 ...
 */
export function rememberSessionSignal( { param, sessionKey, isPositive }: RememberSessionSignalOptions ): boolean {
