 ...
 */
const isDonorValue = ( value: string ) => ! [ 'no', 'none', 'false', '0', '' ].includes( String( value ).toLowerCase() );
 ...
 */
const isUnsubstitutedMergeTag = ( value: string ) =>
 ...
 */
export function isDonorFromEmail(): boolean {
 ...
 */
export function matchDonation( config: SegmentConfig, ras?: MatchingRas ): unknown {
