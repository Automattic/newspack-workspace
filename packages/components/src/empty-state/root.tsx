...
// values spans all four, and both failures are silent. The cast below satisfies
// VStack's prop type without checking these two, so index.test.js is the only guard.
